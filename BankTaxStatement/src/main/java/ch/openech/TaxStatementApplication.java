...
public class TaxStatementApplication extends Application {
	...
	public Class<?>[] getEntityClasses() {
		return new Class<?>[] { TaxStatement.class, BankAccount.class, BankAccountPayment.class, Expense.class, SecurityDepot.class, SecuritySecurity.class, SecurityPayment.class };
	}
}
